...
import {TestMultiHookAdapterV2} from "./mocks/TestMultiHookAdapterV2.sol";
...
contract MultiHookAdapterV2Test is Test, Deployers {
    using PoolIdLibrary for PoolKey;

    TestMultiHookAdapterV2 public adapter;
    ...
    function setUp() public virtual {
        ...
        adapter = TestMultiHookAdapterV2(adapterAddress);
